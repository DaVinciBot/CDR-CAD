...
(library Library_1
	...
	(patternDef "IMB03ITS" (originalName "IMB03ITS")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 3.800, 2.540) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.2 5.54) (pt 8.8 5.54) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.8 5.54) (pt 8.8 -0.46) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.8 -0.46) (pt -1.2 -0.46) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.2 -0.46) (pt -1.2 5.54) (width 0.025))
		)
	...
	(compDef "IMB03ITS" (originalName "IMB03ITS") (compHeader (numPins 4) (numParts 1) (refDesPrefix K)
		...
		(compPin "6" (pinName "NO") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "COIL-") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.te.com/commerce/DocumentDelivery/DDEController?Action=srchrtrv&DocNm=108-98024&DocType=Data%20Sheet&DocLang=English&PartCntxt=2-1462041-5&DocFormat=pdf")
		(attr "<Component Height>" "5.4")
		(attr "<STEP Filename>" "IMB03ITS.stp")

...
(library Library_1
	...
	(compDef "TLV76701DGNR" (originalName "TLV76701DGNR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "IN") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "NC_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "GND_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tlv767.pdf?ts=1634721803014&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTLV767")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TLV76701DGNR.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=-0.03")
